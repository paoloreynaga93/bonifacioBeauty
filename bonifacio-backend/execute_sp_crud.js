...
async function executeStoredProcedures() {
  try {
    console.log('🔄 Ejecutando stored procedures CRUD...');
    
    // Crear SP para insertar
    await pool.query(`
      ...
      $$ LANGUAGE plpgsql
    `);
    console.log('✅ SP crear_parametro creado');
    ...
    await pool.query(`
      ...
      $$ LANGUAGE plpgsql
    `);
    console.log('✅ SP actualizar_parametro creado');
    ...
    await pool.query(`
      ...
      $$ LANGUAGE plpgsql
    `);
    console.log('✅ SP eliminar_parametro creado');
    
    console.log('\n🎉 Stored procedures CRUD creados exitosamente');
